...
CREATE TABLE `opening_hours_special` (
  ...
  CONSTRAINT `opening_hours_special_chk_1` CHECK ((((`isClosed` = 1) and (`openTime` is null) and (`closeTime` is null)) or ((`isClosed` = 0) and (`openTime` is not null) and (`closeTime` is not null) and (`openTime` < `closeTime`))))
...
INSERT INTO `opening_hours_special` VALUES ('2026-02-10','12:00:00','18:00:00',0,'Inventory','2026-01-09 19:16:28',NULL),('2026-02-20',NULL,NULL,1,'Maayan\'s Birthday','2026-01-18 01:01:26',NULL),('2026-04-22',NULL,NULL,1,'Holiday','2026-01-09 19:16:28',NULL);
