...
CREATE TABLE `makeres` (
  `SubscribtionCode` int DEFAULT NULL,
  `ConfCode` varchar(45) NOT NULL,
  `CostumerId` int NOT NULL,
  PRIMARY KEY (`ConfCode`),
  KEY `makeres_ibfk_2` (`SubscribtionCode`),
  KEY `CostumerId` (`CostumerId`),
  CONSTRAINT `CostumerId` FOREIGN KEY (`CostumerId`) REFERENCES `costumer` (`CostumerId`),
  CONSTRAINT `makeres_ibfk_2` FOREIGN KEY (`SubscribtionCode`) REFERENCES `subscriber` (`SubscribtionCode`)
...
-- Dump completed on 2025-12-30 22:47:31
